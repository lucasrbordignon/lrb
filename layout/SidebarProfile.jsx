        ...
        <div className="px-4 py-5 lg:py-6 lg:px-6 rounded-2xl md:px-8 bg-flashWhite dark:bg-metalBlack">
          ...
          <div className="flex items-center justify-between my-4 space-x-4 skills_circle">
            {userDetailsSidebar?.skillsInfo?.map((item) => (
              <div
                key={item?.id}
                className="flex flex-col gap-2 items-center text-center progressCircle"
              >
                <CountUp
                  start={0}
                  end={item?.value}
                        ...
                        return (
                          ...
                          >
                            <div
                              ...
                              ref={countUpRef}
                            >
                              <p className="font-normal dark:font-light text-black dark:text-white/90">
                                {percentage}
                              </p>
                            </div>
                          </CircularProgressbarWithChildren>
          ...
          <div className="mt-6">
            <Link
              href="LUCAS RODRIGUES BORDIGNON.docx"
              download
              target="_blank"
